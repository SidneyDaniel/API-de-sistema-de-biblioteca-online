                            ...
                            <div class="flex flex-row gap-4 w-full">
                                ...
                                <div class="flex flex-col gap-2 w-full">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <InputText id="username" v-model="name" aria-describedby="username-help" size="small" :value="book.name" />
                                    </div>
                                    
                                    <div class="flex flex-col gap-2">
                                        <label for="username">Author</label>
                                        <InputText id="username" v-model="author" aria-describedby="username-help" size="small" />
                                    </div>
                    
                                    <div class="flex flex-col gap-2">
                                        <label for="username">Publisher</label>
                                        <InputText id="username" v-model="publisher" aria-describedby="username-help" size="small" />
                                    </div>
                    
                                    <div class="flex flex-col gap-2">
                                        <label for="username">Pages</label>
                                        <InputText id="username" v-model="pages" aria-describedby="username-help" size="small" />
                                    </div>
    
                                    <div class="flex flex-col gap-2">
                                        <label for="username">Cover</label>
                                        <InputText id="username" v-model="cover" aria-describedby="username-help" size="small" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <Button label="Cancel" text severity="secondary" @click="toggle"  autofocus />
                                <Button label="Save" outlined severity="secondary" @click="toggle"  autofocus />
                            </div>
                    </section>
                </Popover>
            </div>
